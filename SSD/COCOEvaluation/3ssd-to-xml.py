# E:/0909/SSD/COCOEvaluation/3ssd_xml
# E:/0909/SSD/COCOEvaluation/3fire_class.txt
...
# 15 0.448743 0.529142 0.051587 0.021081 0.9999115467071533
# class_number x_yolo y_yolo yolo_width yolo_height score
        ...
        if not image_name == each_yolo_file:
            ...
            with open('XML' + os.sep + each_yolo_file.replace('txt', 'xml'), 'w') as f:
                ...
                for each_line in all_lines:
                    ...
                    # make sure the array has the correct number of items (6 for this format)
                    if len(yolo_array) == 6:
                        ...
                        if yolo_array_contains_only_digits:
                            ...
                            score = float(yolo_array[5])  # Assign score
...
# Check to make sure the XML folder is now in the folder
